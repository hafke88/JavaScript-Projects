...
let activePlayer= 'X';
//This array stroes an array of moves. We use this to determine win conditions.
let selectedSquares= [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/turtle.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the p.png is placed in HTML.
            select.style.backgroundImage= 'url("images/tiger.png")';
        }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line disallows clicking while the wind sound is playing
    disableClick();
    //This line plays the win sounds.
    audio('./media/handbell3.mp3');
...
//This functino resets the game in the event of a tie or a win.
function resetGame() {
