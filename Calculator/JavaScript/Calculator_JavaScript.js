...
function Input_Digit(digit) {
    ...
    // we are checking to see if Wait_Second_Operand is true and set Dislay_Value to the key that was clicked.
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //in the Perfor_Calculation object and the function that matches the
    ...
    // this function updates the screen with the countents of Display_Value
    ...
    keys.addEventListener('click', (event) => {
        ...
        // ensures that AC clears the umbers from the Calculator
